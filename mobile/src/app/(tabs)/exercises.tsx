...
const EXERCISES = [
  { id: "1", name: "Squats", active: true, targetReps: 10 },
  { id: "2", name: "Deadlift", active: false, targetReps: null },
  { id: "3", name: "Lunges", active: false, targetReps: null },
  { id: "4", name: "Push-ups", active: false, targetReps: null },
  { id: "5", name: "Overhead Press", active: false, targetReps: null },
  { id: "6", name: "Plank", active: false, targetReps: null },
  { id: "7", name: "Bench Press", active: false, targetReps: null },
  { id: "8", name: "Pull-ups", active: false, targetReps: null },
  { id: "9", name: "Barbell Rows", active: false, targetReps: null },
  { id: "10", name: "Bicep Curls", active: false, targetReps: null },
];
      ...
      {EXERCISES.map((item) => (
        ...
        >
          <View className="flex-1">
            ...
            {item.targetReps ? (
              <Text className="mt-1 text-white/50 text-xs">
